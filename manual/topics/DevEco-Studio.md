...
DevEco Studio 5 (**at least version 5.1.1**) is officially supported by Extra Tools Pack, Extra Icons, Extra ToolWindow Colorful Icons and Extra IDE Tweaks.
...
> My plugins are not (yet) listed in the plugin browser built into DevEco Studio, because Huawei uses a whitelist of plugins, and I am having difficulty getting approval from their support team (I already tried 5 times, but I won't give up). This is why you have to install them manually. 
> 
...
- In DevEco Studio, go to <ui-path>Help | Register Plugins...</ui-path>, select the plugin you want to activate, click on **Activate code**, then paste your offline activation code, click on **Activate**.
...
## DevEco Studio 6 support

DevEco Studio 6 will also be officially supported once it's available outside from China. While that, I will provide builds that should be compatible, but I cannot test by myself.  
If you have access to DevEco Studio 6, I would be happy to read your feedback ;-)
