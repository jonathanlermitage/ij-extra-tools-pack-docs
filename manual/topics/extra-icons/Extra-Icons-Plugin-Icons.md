...
![](../../images/extra-icons/plugin-icons.png){ width="640" }{ thumbnail="true" }
...
![](../../images/extra-icons/plugin-icons-line.png){ width="640" }
...
5. if you see the <img src="reboot.svg" style="inline"/>icon in this column, that means you need to restart your IDE to apply changes. Otherwise, changes are applied once you validate the form
