...
| `pluginID`          | The ID of the plugin reporting the data.<br>*Currently not collected. Will be enabled in a future plugin update*.           | `lermitage.ij.all.pack`, `lermitage.ij.all.pack.lifetime`, `lermitage.ij.extra.icons.lifetime`     |
| `pluginLicenseType` | The license type of the plugin reporting the data.<br>*Currently not collected. Will be enabled in a future plugin update*. | `paid`, `freemium`, `other`                                                                        |
| `pluginVersion`     | The version of the plugin reporting the data.<br>*Currently not collected. Will be enabled in a future plugin update*.      | `2026.1.6`, `2026.1.5`                                                                             |
